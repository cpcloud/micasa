...
// punctuation glued to words ("project?" -> "project"). Defined at
// package scope so the compiler treats it as a static function pointer
// rather than a per-iteration closure.
